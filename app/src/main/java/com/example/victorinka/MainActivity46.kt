...
import com.example.victorinka.databinding.ActivityMain46Binding

class MainActivity46 : AppCompatActivity() {
    lateinit var binding: ActivityMain46Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain46Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity47::class.java)
            startActivity(intent)
        }
