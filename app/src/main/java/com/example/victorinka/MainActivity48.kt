...
import com.example.victorinka.databinding.ActivityMain48Binding

class MainActivity48 : AppCompatActivity() {
    lateinit var binding: ActivityMain48Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain48Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity49::class.java)
            startActivity(intent)
        }
