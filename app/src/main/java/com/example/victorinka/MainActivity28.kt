...
import com.example.victorinka.databinding.ActivityMain28Binding

class MainActivity28 : AppCompatActivity() {
    lateinit var binding: ActivityMain28Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain28Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity29::class.java)
            startActivity(intent)
        }
