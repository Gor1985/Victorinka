...
import com.example.victorinka.databinding.ActivityMain35Binding

class MainActivity35 : AppCompatActivity() {
    lateinit var binding: ActivityMain35Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain35Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity36::class.java)
            startActivity(intent)
        }
