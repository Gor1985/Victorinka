...
import com.example.victorinka.databinding.ActivityMain47Binding

class MainActivity47 : AppCompatActivity() {
    lateinit var binding: ActivityMain47Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain47Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity48::class.java)
            startActivity(intent)
        }
