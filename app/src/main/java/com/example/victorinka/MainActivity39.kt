...
import com.example.victorinka.databinding.ActivityMain39Binding

class MainActivity39 : AppCompatActivity() {
    lateinit var binding: ActivityMain39Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity40::class.java)
            startActivity(intent)
        }
