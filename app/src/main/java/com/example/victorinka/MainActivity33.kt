...
import com.example.victorinka.databinding.ActivityMain33Binding

class MainActivity33 : AppCompatActivity() {
    lateinit var binding: ActivityMain33Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain33Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity34::class.java)
            startActivity(intent)
        }
