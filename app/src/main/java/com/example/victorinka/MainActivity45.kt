...
import com.example.victorinka.databinding.ActivityMain45Binding

class MainActivity45 : AppCompatActivity() {
    lateinit var binding: ActivityMain45Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain45Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity46::class.java)
            startActivity(intent)
        }
