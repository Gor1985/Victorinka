...
import com.example.victorinka.databinding.ActivityMain19Binding

class MainActivity19 : AppCompatActivity() {
    lateinit var binding: ActivityMain19Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity20::class.java)
            startActivity(intent)
        }
