...
import com.example.victorinka.databinding.ActivityMain23Binding

class MainActivity23 : AppCompatActivity() {
    lateinit var binding: ActivityMain23Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity24::class.java)
            startActivity(intent)
        }
