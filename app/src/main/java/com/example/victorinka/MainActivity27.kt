...
import com.example.victorinka.databinding.ActivityMain27Binding

class MainActivity27 : AppCompatActivity() {
    lateinit var binding: ActivityMain27Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain27Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity28::class.java)
            startActivity(intent)
        }
