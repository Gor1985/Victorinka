...
import com.example.victorinka.databinding.ActivityMain38Binding

class MainActivity38 : AppCompatActivity() {
    lateinit var binding: ActivityMain38Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain38Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity39::class.java)
            startActivity(intent)
        }
