...
import com.example.victorinka.databinding.ActivityMain40Binding

class MainActivity40 : AppCompatActivity() {
    lateinit var binding: ActivityMain40Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain40Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity41::class.java)
            startActivity(intent)
        }
