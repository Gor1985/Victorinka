...
import com.example.victorinka.databinding.ActivityMain44Binding

class MainActivity44 : AppCompatActivity() {
    lateinit var binding: ActivityMain44Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain44Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity45::class.java)
            startActivity(intent)
        }
