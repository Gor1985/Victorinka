...
import com.example.victorinka.databinding.ActivityMain30Binding

class MainActivity30 : AppCompatActivity() {
    lateinit var binding: ActivityMain30Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain30Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity31::class.java)
            startActivity(intent)
        }
