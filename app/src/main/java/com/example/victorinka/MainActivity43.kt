...
import com.example.victorinka.databinding.ActivityMain43Binding

class MainActivity43 : AppCompatActivity() {
    lateinit var binding: ActivityMain43Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain43Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity44::class.java)
            startActivity(intent)
        }
