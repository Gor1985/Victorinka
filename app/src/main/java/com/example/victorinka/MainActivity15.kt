...
import com.example.victorinka.databinding.ActivityMain15Binding

class MainActivity15 : AppCompatActivity() {
    lateinit var binding: ActivityMain15Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity16::class.java)
            startActivity(intent)
        }
