...
import com.example.victorinka.databinding.ActivityMain32Binding

class MainActivity32 : AppCompatActivity() {
    lateinit var binding: ActivityMain32Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity33::class.java)
            startActivity(intent)
        }
