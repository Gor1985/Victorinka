...
import com.example.victorinka.databinding.ActivityMain34Binding

class MainActivity34 : AppCompatActivity() {
    lateinit var binding: ActivityMain34Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain34Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity35::class.java)
            startActivity(intent)
        }
