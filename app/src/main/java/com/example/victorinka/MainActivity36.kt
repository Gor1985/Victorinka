...
import com.example.victorinka.databinding.ActivityMain36Binding

class MainActivity36 : AppCompatActivity() {
    lateinit var binding: ActivityMain36Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding= ActivityMain36Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity37::class.java)
            startActivity(intent)
        }
