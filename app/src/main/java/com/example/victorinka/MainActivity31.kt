...
import com.example.victorinka.databinding.ActivityMain31Binding

class MainActivity31 : AppCompatActivity() {
    lateinit var binding: ActivityMain31Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity32::class.java)
            startActivity(intent)
        }
