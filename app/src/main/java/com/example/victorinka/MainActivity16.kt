...
import com.example.victorinka.databinding.ActivityMain16Binding

class MainActivity16 : AppCompatActivity() {
    lateinit var binding: ActivityMain16Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity17::class.java)
            startActivity(intent)
        }
