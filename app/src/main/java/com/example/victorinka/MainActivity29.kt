...
import com.example.victorinka.databinding.ActivityMain29Binding

class MainActivity29 : AppCompatActivity() {
    lateinit var binding: ActivityMain29Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain29Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity30::class.java)
            startActivity(intent)
        }
