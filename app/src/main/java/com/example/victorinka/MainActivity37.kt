...
import com.example.victorinka.databinding.ActivityMain37Binding

class MainActivity37 : AppCompatActivity() {
    lateinit var binding: ActivityMain37Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain37Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity38::class.java)
            startActivity(intent)
        }
