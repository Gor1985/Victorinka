...
import com.example.victorinka.databinding.ActivityMain18Binding

class MainActivity18 : AppCompatActivity() {
    lateinit var binding: ActivityMain18Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity19::class.java)
            startActivity(intent)
        }
