...
import com.example.victorinka.databinding.ActivityMain42Binding


class MainActivity42 : AppCompatActivity() {
    lateinit var binding: ActivityMain42Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMain42Binding.inflate(layoutInflater)
        ...
        binding.newPlay.setOnClickListener {
            var intent = Intent(this, MainActivity43::class.java)
            startActivity(intent)
        }
